...
<head>
    ...
    <title>Daftar - Sistem Zakat Fitrah</title>
    <meta name="description" content="Daftar akun baru untuk aplikasi pengelolaan zakat fitrah">
            ...
            <div class="w-full max-w-md">
                ...
                <div class="glass-effect p-8 rounded-2xl shadow-lg border border-gray-100">
                    <div class="text-center mb-8">
                        <h2 class="text-2xl font-bold text-gray-800 font-display">Buat Akun Baru</h2>
                        <p class="text-gray-600 mt-2">Mulai perjalanan Anda bersama kami</p>
                    </div>
                    ...
                    <form class="space-y-5" method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <input id="name" name="name" type="text" autocomplete="name" required value="{{ old('name') }}" 
                                    class="pl-11 block w-full px-4 py-3.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition duration-200 @error('name') border-red-500 @enderror" 
                        ...
                        <div>
                            ...
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required 
                                    class="pl-11 block w-full px-4 py-3.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition duration-200" 
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-gray-700">
                                Saya setuju dengan <a href="#" class="text-primary-600 hover:text-primary-700">Syarat & Ketentuan</a> dan <a href="#" class="text-primary-600 hover:text-primary-700">Kebijakan Privasi</a>
                            </label>
                        </div>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-base text-gray-600">
                            Sudah memiliki akun?
                            <a href="{{ route('login') }}" class="font-medium text-primary-600 hover:text-primary-700 transition duration-200">
                                Masuk
                            </a>
                        </p>
                    </div>
