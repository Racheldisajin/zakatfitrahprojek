...
@section('title', 'Tambah Muzakki Baru - Sistem Zakat Fitrah')
...
<div class="py-12 bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:justify-between md:items-center">
            <div class="mb-4 md:mb-0">
                <h1 class="text-3xl font-bold text-secondary-dark">
                    <span class="inline-block border-b-4 border-primary-DEFAULT pb-1">Tambah Muzakki</span>
                </h1>
                <p class="mt-2 text-secondary-DEFAULT text-opacity-80">Formulir untuk menambahkan data pembayar zakat baru ke dalam sistem</p>
            </div>
            <div>
        ...
        <div class="bg-white rounded-xl shadow-custom overflow-hidden border border-gray-100">
            ...
            <!-- Form Content -->
            <div class="p-6">
                <form action="{{ route('muzakki.store') }}" method="POST" class="space-y-8" id="muzakki-form">
                    @csrf
                        ...
                        <div class="flex flex-col h-full justify-between">
                            <div class ="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_muzakki" id="nama_muzakki" value="{{ old('nama_muzakki') }}" 
            ...
            <div class="bg-white px-6 py-6">
                <div class="text-center mb-5">
                    <p class="text-base text-gray-600 mb-2">
                        Anda akan menyimpan data muzakki baru:
                    </p>
...
@push('scripts')
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Add validation highlights for required fields
        const form = document.querySelector('form');
        
        // Prevent default form submission
        form.addEventListener('submit', function(e) {
            e.preventDefault();
            // Form will be submitted via JavaScript
        });
        
        // Add event listener to submit button in modal
        ...
        // Event handlers for form validation are moved to the showSaveModal function
    });
