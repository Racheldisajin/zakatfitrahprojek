    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('muzakki.index') }}" class="text-gray-300 hover:text-white transition duration-300">Muzakki</a></li>
                    <li><a href="{{ route('mustahik.index') }}" class="text-gray-300 hover:text-white transition duration-300">Mustahik</a></li>
                    <li><a href="{{ route('bayarzakat.index') }}" class="text-gray-300 hover:text-white transition duration-300">Pengumpulan</a></li>
                    <li><a href="{{ route('distribusi.index') }}" class="text-gray-300 hover:text-white transition duration-300">Distribusi</a></li>
                    <li><a href="{{ route('laporan.index') }}" class="text-gray-300 hover:text-white transition duration-300">Laporan</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-gray-700 mt-12 pt-8">
            <p class="text-gray-400 text-center">
                &copy; {{ date('Y') }} Sistem Zakat Fitrah. Hak Cipta Dilindungi.
            </p>
        </div>
    </div>
</footer> 